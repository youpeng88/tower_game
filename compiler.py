...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "tower_game.py"
 
        #Name of program
        self.project_name = "6.177 Tower Defense"
 
        #Project url
        self.project_url = "https://github.com/youpeng88/tower_game.git"
 
        #Version of program
        self.project_version = "1.0"
 
        #License of the program
        self.license = "Uses Pygame 1.9"
 
        #Auhor of program
        self.author_name = "Alexander Andriatis, You Peng, Zachary Buras"
        self.author_email = "aandriat@mit.edu, youpeng@mit.edu, zjburas@mit.edu"
        self.copyright = "No Copyright"
 
        #Description
        self.project_description = "Tower Defense Game for MIT 6.177 Building Programing Experience with Python"
